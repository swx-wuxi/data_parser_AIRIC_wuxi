...
_CROSSWALK.fields_by_name['id'].message_type = map__id__pb2._ID
_CROSSWALK.fields_by_name['polygon'].message_type = map__geometry__pb2._POLYGON
_CROSSWALK.fields_by_name['overlap_id'].message_type = map__id__pb2._ID
