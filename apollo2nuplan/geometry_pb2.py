...
_CURVE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='point', full_name='apollo.common.Curve.point', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CURVE.fields_by_name['point'].message_type = _POINTENU
...
Curve = _reflection.GeneratedProtocolMessageType('Curve', (_message.Message,), {
  'DESCRIPTOR' : _CURVE,
  '__module__' : 'geometry_pb2'
  # @@protoc_insertion_point(class_scope:apollo.common.Curve)
  })
