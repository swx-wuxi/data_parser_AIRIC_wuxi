...
_PNCJUNCTION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='virtual', full_name='apollo.hdmap.PNCJunction.virtual', index=4,
...
_PASSAGE.fields_by_name['id'].message_type = map__id__pb2._ID
_PASSAGE.fields_by_name['signal_id'].message_type = map__id__pb2._ID
_PASSAGE.fields_by_name['yield_id'].message_type = map__id__pb2._ID
_PASSAGE.fields_by_name['stop_sign_id'].message_type = map__id__pb2._ID
_PASSAGE.fields_by_name['lane_id'].message_type = map__id__pb2._ID
_PASSAGE.fields_by_name['type'].enum_type = _PASSAGE_TYPE
_PASSAGE_TYPE.containing_type = _PASSAGE
_PASSAGEGROUP.fields_by_name['id'].message_type = map__id__pb2._ID
_PASSAGEGROUP.fields_by_name['passage'].message_type = _PASSAGE
_PNCJUNCTION.fields_by_name['id'].message_type = map__id__pb2._ID
_PNCJUNCTION.fields_by_name['polygon'].message_type = map__geometry__pb2._POLYGON
_PNCJUNCTION.fields_by_name['overlap_id'].message_type = map__id__pb2._ID
